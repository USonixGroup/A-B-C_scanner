...
import numpy as np
from api.src.rig_function import send_command, enable_axis, wait_until_stopped
from scipy.signal import butter, detrend, hilbert, sosfiltfilt, windows
from api.src.move import mm_to_pulse

try:
    from api.src.dummy_signal_generator import generate_dummy_echo as _generate_dummy_echo
except Exception:
...
SETTINGS_PATH = Path(__file__).resolve().parent.parent.parent / "data" / "gui_settings.json"
